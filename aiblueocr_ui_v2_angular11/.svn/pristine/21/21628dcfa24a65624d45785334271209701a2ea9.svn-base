...
@Component({
    selector: 'app-modellearn',
    templateUrl: './modellearn.component.html',
    styleUrls: ['./modellearn.component.scss'],
})
export class ModelLearnComponent implements OnInit, OnDestroy {
    ...
    search() {
        ...
        const serviceUrl = 'model/aimodel/selectList';
